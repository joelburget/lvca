...
type operator_def = Types.operator_def = OperatorDef of string * arity
  (** An operator is defined by its tag and arity *)

type sort_def = Types.sort_def = SortDef of string list * operator_def list
...
type sort_defs = Types.sort_defs = SortDefs of sort_def Util.String.Map.t
...
type abstract_syntax = Types.abstract_syntax =
  { imports : import list
  ; sort_defs : sort_defs
  }
