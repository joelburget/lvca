...
(* This file was auto-generated based on "src/ConcreteSyntaxParser.messages". *)
...
let message =
  fun s ->
    ...
    | 6 ->
        "Invalid terminal rule declaration.\n"
    | 16 ->
    ...
    | 19 ->
        "Invalid declaration of a sort (nonterminal).\n"
    | 27 ->
