...
(** {1 Types} *)
type 'info n_term = ('info, 'info Lvca_syntax.Primitive.t) Lvca_syntax.Nominal.Term.t

type 'info pattern = ('info, 'info Lvca_syntax.Primitive.t) Lvca_syntax.BindingAwarePattern.t
